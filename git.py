...
gitconfig = {
    'cwd': '.',
    'git': {
        'github': ['https://github.com/wchat/Instant.git', 'master'],
...
def main():
    ...
    git_remotes_list = [line.split()[0]
                        for line in git_remotes_str.split('\n')]
    ...
    commit_message = 'Site updated: %s' % time.strftime(
